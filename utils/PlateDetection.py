...
class PlateDetector():
    ...
    def find_possible_plates(self, input_img):
        ...
        idx=[]
        for i,cnts in enumerate(possible_plate_contours):
            plate, characters_on_plate, coordinates,bbox =  self.check_plate(input_img, cnts)
    ...
    def extract_contours(self, after_preprocess):
        extracted_contours, _ = cv2.findContours(after_preprocess, mode=cv2.RETR_EXTERNAL, method=cv2.CHAIN_APPROX_NONE)
    ...
    def check_plate(self, input_img, contour):
        ...
        if self.validateRotationAndRatio(min_rect):
            ...
            if plateFound:
                ...
                return after_check_plate_img, None, coordinates, [x,y,w1,h1]
